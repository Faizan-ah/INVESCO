...
export class StockMainPage extends Component {
    ...
    getData = ()=>{
        var starCountRef = fire.database().ref('historicaldatafyp-default-rtdb/historicaldatafyp-default-rtdb/Stocks/HASCOL');
    ...
    componentDidMount(){
        ...
        .once('value',(inspectorsSnapshot)=> {
            ...
            console.log('qweqweqwe',this.state.series)
                */
            }
            ...
            <div>
                ...
                <div className='stock-page-main'>
                    <div className='plot-graph'>
                        {/* <PlotChart chartData={this.state.chartData} style={{ height:'2000px'}}/> */}
                        <ReactApexCharts options={this.state.options} series={this.state.series} type="candlestick" height={350} />
                    </div>
